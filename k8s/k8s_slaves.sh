...
rm -f $file
cat >> $file << EOF
kubeadm join api.k8s.at.bronzels:6443 --token lp4wmy.nzabs7u0dvwb7esj     --discovery-token-ca-cert-hash sha256:b88e6e7639e09c48cd358d5db31d0f5c73a59b6d68f15f099b6b9da367f4d5fb
EOF
