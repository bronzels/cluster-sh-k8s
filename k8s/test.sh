...
start=$(date +"%s.%9N")
for i in `seq 4`; do curl 100.95.202.134:8080; done
end=$(date +"%s.%9N")
echo timediff:`echo "scale=9;$end - $start" | bc`
:<<EOF
(app-root) start=$(date +"%s.%9N")
(app-root) for i in `seq 4`; do curl 100.95.202.134:8080; done
<p>Hello from service-test-db6d56f8f-cxbgn</p>
<p>Hello from service-test-db6d56f8f-cxbgn</p>
<p>Hello from service-test-db6d56f8f-cxbgn</p>
<p>Hello from service-test-db6d56f8f-cxbgn</p>
(app-root) end=$(date +"%s.%9N")
(app-root) echo timediff:`echo "scale=9;$end - $start" | bc`
timediff:.023271437
EOF

start=$(date +"%s.%9N")
for i in `seq 4`; do curl 10.96.3.188:8088; done
end=$(date +"%s.%9N")
echo timediff:`echo "scale=9;$end - $start" | bc`
:<<EOF
(app-root) start=$(date +"%s.%9N")
...
start=$(date +"%s.%9N")
for i in `seq 4`; do curl service-test:8088; done
end=$(date +"%s.%9N")
echo timediff:`echo "scale=9;$end - $start" | bc`
:<<EOF
(app-root) start=$(date +"%s.%9N")
(app-root) for i in `seq 4`; do curl service-test:8088; done
<p>Hello from service-test-db6d56f8f-lf5dr</p>
<p>Hello from service-test-db6d56f8f-gjxpj</p>
<p>Hello from service-test-db6d56f8f-gkglr</p>
<p>Hello from service-test-db6d56f8f-cxbgn</p>
...
start=$(date +"%s.%9N")
for i in `seq 4`; do curl www.baidu.com; done
end=$(date +"%s.%9N")
echo timediff:`echo "scale=9;$end - $start" | bc`
:<<EOF
(app-root) start=$(date +"%s.%9N")
(app-root) for i in `seq 4`; do curl www.baidu.com; done
<!DOCTYPE html>
...
:<<EOF
(app-root) curl  -o /dev/null -s -w %{time_namelookup}::%{time_connect}::%{time_total}"\n" service-test:8088
0.005::0.006::0.008
(app-root) curl  -o /dev/null -s -w %{time_namelookup}::%{time_connect}::%{time_total}"\n" service-test:8088
0.006::0.007::0.009
(app-root) curl  -o /dev/null -s -w %{time_namelookup}::%{time_connect}::%{time_total}"\n" service-test:8088
