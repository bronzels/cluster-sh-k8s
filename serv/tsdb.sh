...
curl -ki -X POST -d '{"metric":"testdata", "timestamp":1524900185000, "value":9999.99, "tags":{"key":"value"}}' http://1110.1110.1.62:31042/api/put?sync
curl  -X POST -H "Accept:application/json" -H  "Content-Type:application/json" http://1110.1110.1.62:31042/api/query  -d '
    {
