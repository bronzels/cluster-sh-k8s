...
hk-prod-bigdata-slave-3-233 ansible_ssh_user=root ansible_ssh_pass=root
...
hk-prod-bigdata-slave-3-233 ansible_ssh_user=ubuntu ansible_ssh_pass=ubuntu
...
10.10.3.233 hk-prod-bigdata-slave-3-233
...
slave03 hk-prod-bigdata-slave-3-233
...
- hosts: all
  ...
  - name: install ssh key
    authorized_key: user=root
                    ...
                    state=present
EOF
ssh-keyscan hk-prod-bigdata-master-7-44 hk-prod-bigdata-master-14-114 hk-prod-bigdata-slave-0-234 hk-prod-bigdata-slave-10-34 hk-prod-bigdata-slave-3-233 hk-prod-bigdata-slave-5-226 >> ~/.ssh/known_hosts
